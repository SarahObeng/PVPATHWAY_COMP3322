...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 21, 2026 at 10:49 PM
...
INSERT INTO `movie` (`column_ID`, `Title`, `Rating`, `ReleaseDate`, `genreID`) VALUES
(1, 'The Dark Knight', '5.0', '2008-07-18', 1),
(2, 'Inception', '4.7', '2010-07-16', 2),
(3, 'Interstellar', '3.8', '2014-11-07', 3),
(4, 'Everything Everywhere All at Once', '2.5', '2022-03-25', 4),
(5, 'Spider-Man: Into the Spider-Verse', '2.0', '2018-12-14', 5);
...
('root', '[{\"db\":\"pvamu_registration\",\"table\":\"degree_plan\"},{\"db\":\"pvamu_registration\",\"table\":\"enrollment\"},{\"db\":\"pvamu_registration\",\"table\":\"waitlist\"},{\"db\":\"pvamu_registration\",\"table\":\"student\"},{\"db\":\"pvamu_registration\",\"table\":\"major\"},{\"db\":\"pvamu_registration\",\"table\":\"section\"},{\"db\":\"pvamu_registration\",\"table\":\"course\"}]');
...
('root', '2026-02-21 20:12:05', '{\"Console\\/Mode\":\"collapse\",\"NavigationWidth\":0}');
...
--
CREATE DATABASE IF NOT EXISTS `pvamu_registration` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
...
CREATE TABLE `student` (
  ...
  `total_credits_completed` tinyint(4) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
ALTER TABLE `student`
  MODIFY `student_id` tinyint(4) NOT NULL AUTO_INCREMENT;
